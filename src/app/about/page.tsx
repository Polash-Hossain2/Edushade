...
function About() {
  return (
    <section>
        <div className='max-w-4xl mx-auto p- bg-white'>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3 mt-4">
             ...
             <div className='bg-white rounded-xl p-2 mt-4  border-[1.5px] border-gray-300'>
                ...
                <div className='flex p-2'>
                    ...
                    <p className='text-[13px] mt-0.5 text-cyan-600 cursor-pointer'>৭টি স্থান অবশিষ্ট</p>
                </div>
             </div>
             <div className='grid grid-cols-1 md:grid-cols-2 gap-3 mt-4 '>
                <div className='gap-3 mt-1.5 border-[1.5px] border-cyan-800 rounded-lg m-1 '>
                    <div className=''>
                        <Button variant="ghost" className='w-[100%] disabled:cursor-not-allowed text-center  w-ful
                         bg-white text-[12px] text-gray-500 font-bold hover:bg-white 
                          font-sans  hover:text-white-600 cursor-pointer'>
                                 ইভেন্ট শেয়ার করুন
                       </Button>
                    </div>
                </div>
